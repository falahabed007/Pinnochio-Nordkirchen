# PayPal-Setup (Pinocchio Nordkirchen)
...
In `PinocchioNordkirchen/.env` (lokal) **und** in Render (Service-ENV) ergänzen:
...
2. **Webhooks** → URL `https://pinnochionordkirchen.de/api/paypal-webhook` hinzufügen,
